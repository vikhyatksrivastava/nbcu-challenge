...
def processCSVtoDataframeAndTable(filename):
    ...
    datafile.coalesce(1).write.option("header", "true").csv('../peacock-de-eval/output/Source_Message_Data',
                                                            'overwrite')
    fetchAndRenameFile('../peacock-de-eval/output/Source_Message_Data/',
                       '../peacock-de-eval/output/Source_Message_Data.csv')
    shutil.rmtree('../peacock-de-eval/output/Source_Message_Data/')
    return datafile
...
def getAnalytics(fileName):
    ...
    orderedItemDf.coalesce(1).write.option("header", "true").csv('../peacock-de-eval/output/Most_Popular_Titles',
                                                                 'overwrite')
    fetchAndRenameFile('../peacock-de-eval/output/Most_Popular_Titles/',
                       '../peacock-de-eval/output/Most_Popular_Titles.csv')
    shutil.rmtree('../peacock-de-eval/output/Most_Popular_Titles/')
    ...
    orderedIdDf.coalesce(1).write.option("header", "true").csv('../peacock-de-eval/output/Id_Counts_By_Rating',
                                                               'overwrite')
    fetchAndRenameFile('../peacock-de-eval/output/Id_Counts_By_Rating/',
                       '../peacock-de-eval/output/Id_Counts_By_Rating.csv')
    shutil.rmtree('../peacock-de-eval/output/Id_Counts_By_Rating/')
    ...
    orderedDtDf.coalesce(1).write.option("header", "true").csv('../peacock-de-eval/output/Daily_Count_of_Rating',
                                                               'overwrite')
    fetchAndRenameFile('../peacock-de-eval/output/Daily_Count_of_Rating/',
                       '../peacock-de-eval/output/Daily_Count_of_Rating.csv')
    shutil.rmtree('../peacock-de-eval/output/Daily_Count_of_Rating/')
    ...
    orderedItemDtDf.coalesce(1).write.option("header", "true").csv(
        '../peacock-de-eval/output/Daily_Item_Count_Rated',
        'overwrite')
    fetchAndRenameFile('../peacock-de-eval/output/Daily_Item_Count_Rated/',
                       '../peacock-de-eval/output/Daily_Item_Count_Rated.csv')
    shutil.rmtree('../peacock-de-eval/output/Daily_Item_Count_Rated/')
...
def fetchAndRenameFile(partFilePath, outputFilePath):
    ...
    part_files = [file for file in files if (file.startswith("part-") and file.endswith(".csv"))]
...
def main():
    fileName = "../peacock-de-eval/output/messages.csv"
